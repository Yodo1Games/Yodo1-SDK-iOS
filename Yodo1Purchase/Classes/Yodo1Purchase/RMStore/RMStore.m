...
#if DEBUG
#define RMStoreLog(...) NSLog(@"[Yodo1 SDK]: %@", [NSString stringWithFormat:__VA_ARGS__]);
#else
#define RMStoreLog(...)
#endif
...
- (SKPayment*)rm_payment {
    return (self.userInfo)[RMStoreNotificationPromotion];
}
...
- (BOOL)paymentQueue:(SKPaymentQueue *)queue shouldAddStorePayment:(SKPayment *)payment forProduct:(SKProduct *)product {
    NSDictionary *userInfo = @{ RMStoreNotificationPromotion : payment };
