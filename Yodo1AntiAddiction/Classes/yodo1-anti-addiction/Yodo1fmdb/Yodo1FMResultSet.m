    ...
    if (SQLITE_BUSY == rc || SQLITE_LOCKED == rc) {
        ...
        if (outErr) {
            if (_parentDB) {
                ...
                *outErr = [NSError errorWithDomain:@"Yodo1FMDatabase" code:SQLITE_MISUSE userInfo:errorMessage];
            }
