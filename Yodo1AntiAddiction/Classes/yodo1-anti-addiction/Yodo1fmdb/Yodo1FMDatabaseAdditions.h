...
/** Category of additions for `<Yodo1FMDatabase>` class.
...
@interface Yodo1FMDatabase (Yodo1FMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `Yodo1FMResultSet` of schema; `nil` on error.
