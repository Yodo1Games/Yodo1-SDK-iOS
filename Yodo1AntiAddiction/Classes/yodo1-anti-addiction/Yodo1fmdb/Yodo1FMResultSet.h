...
@class Yodo1FMStatement;

/** Represents the results of executing a query on an `<Yodo1FMDatabase>`.
...
@interface Yodo1FMResultSet : NSObject

@property (nonatomic, retain, nullable) Yodo1FMDatabase *parentDB;
...
/** `Yodo1FMStatement` used by result set. */

@property (atomic, retain, nullable) Yodo1FMStatement *statement;

///------------------------------------
/// @name Creating and closing a result set
///------------------------------------

/** Create result set from `<Yodo1FMStatement>`
 
 @param statement A `<Yodo1FMStatement>` to be performed
 
 @param aDB A `<Yodo1FMDatabase>` to be used
 
 @return A `Yodo1FMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(Yodo1FMStatement *)statement usingParentDatabase:(Yodo1FMDatabase*)aDB;
